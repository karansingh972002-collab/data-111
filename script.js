...
const iphonePhotoUrls = {
  side: "https://images.unsplash.com/photo-1642227140165-534d29b48f70?auto=format&fit=crop&w=900&q=80",
  red: "https://images.unsplash.com/photo-1573920011462-eb3003086611?auto=format&fit=crop&w=900&q=80",
  black: "https://images.unsplash.com/photo-1709528922440-4fc4f05ef110?auto=format&fit=crop&w=900&q=80",
  white: "https://images.unsplash.com/photo-1555375771-14b2a63968a9?auto=format&fit=crop&w=900&q=80",
  desk: "https://images.unsplash.com/photo-1621768216002-5ac171876625?auto=format&fit=crop&w=900&q=80"
};

// Map product IDs to real image URLs.
const productImages = {
  19: iphonePhotoUrls.black,
  20: iphonePhotoUrls.side,
  21: iphonePhotoUrls.white,
  24: "assets/products/24-ultrabook-air-14.png",
  32: iphonePhotoUrls.red,
  33: iphonePhotoUrls.black,
  34: iphonePhotoUrls.desk,
  35: iphonePhotoUrls.white,
  36: iphonePhotoUrls.side,
  37: iphonePhotoUrls.black,
  38: iphonePhotoUrls.desk,
  39: iphonePhotoUrls.red,
  40: iphonePhotoUrls.white,
  41: iphonePhotoUrls.black,
  42: iphonePhotoUrls.desk,
  43: iphonePhotoUrls.side,
  44: iphonePhotoUrls.black,
  45: iphonePhotoUrls.desk,
  46: iphonePhotoUrls.white,
  47: iphonePhotoUrls.black,
  48: iphonePhotoUrls.desk,
  49: iphonePhotoUrls.side,
  50: iphonePhotoUrls.white,
  51: iphonePhotoUrls.black,
  52: iphonePhotoUrls.white,
  53: iphonePhotoUrls.side,
  54: iphonePhotoUrls.red,
  55: iphonePhotoUrls.red,
  56: iphonePhotoUrls.black,
  57: iphonePhotoUrls.desk,
  58: iphonePhotoUrls.black
};
...
function productImg(product) {
  if (productImages[product.id]) {
    const separator = productImages[product.id].includes("?") ? "&" : "?";
    return `<img
      src="${productImages[product.id]}${separator}v=${ASSET_VERSION}"
      alt="${product.name}"
